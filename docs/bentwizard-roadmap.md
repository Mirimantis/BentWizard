...
- **Preview Mated Joint UI**: the run-again-to-clear toggle works but is unintuitive. Wants a clearer affordance (a visible preview state / dedicated clear, or a live-updating preview panel). Also consider previewing at the primary's real location vs. a neutral inspection pose as an option.
