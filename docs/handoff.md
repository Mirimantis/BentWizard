...
frame*; spike round 2). Not built yet — **the build brief is
[rebuild-flat-frame-handoff.md](rebuild-flat-frame-handoff.md)**
(workstreams, contracts, verification, open questions). Fixed in the
